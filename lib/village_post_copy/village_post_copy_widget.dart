...
import 'village_post_copy_model.dart';
export 'village_post_copy_model.dart';

class VillagePostCopyWidget extends StatefulWidget {
  const VillagePostCopyWidget({super.key});

  @override
  _VillagePostCopyWidgetState createState() => _VillagePostCopyWidgetState();
}

class _VillagePostCopyWidgetState extends State<VillagePostCopyWidget> {
  late VillagePostCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VillagePostCopyModel());
